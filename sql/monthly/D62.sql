-- ============================================================================
-- D62_two_axis_patterns_optimized_buy
-- 2軸パターンの損切・利確幅最適化（BUY版）
-- 
-- 期間設定（ここを変更すれば全体に反映）
-- ============================================================================
...
-- 既存テーブル削除
DROP TABLE IF EXISTS `kabu-376213.kabu2411.D62_two_axis_patterns_optimized_buy`;

-- 新規作成
CREATE TABLE `kabu-376213.kabu2411.D62_two_axis_patterns_optimized_buy` AS
WITH 
-- 1. 候補パターンの取得
candidate_patterns AS (
  SELECT * 
  FROM `kabu-376213.kabu2411.D61_two_axis_candidate_patterns_buy`
