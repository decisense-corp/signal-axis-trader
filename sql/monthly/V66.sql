...
CREATE OR REPLACE VIEW `kabu-376213.kabu2411.V66_cream_patterns_buy` AS
WITH cream_candidates AS (
  ...
  FROM `kabu-376213.kabu2411.V65_two_axis_validation_results_buy` v
  WHERE 
    -- 基本条件（BUYの成功基準を適用）
