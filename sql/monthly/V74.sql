-- ============================================================================
-- V74_cream_patterns_sell（2層目）
-- 厳選条件でフィルタリング
-- ============================================================================

CREATE OR REPLACE VIEW `kabu-376213.kabu2411.V74_cream_patterns_sell` AS
WITH cream_candidates AS (
  ...
  FROM `kabu-376213.kabu2411.V73_two_axis_validation_results_sell` v
  WHERE 
    -- 基本条件（SELLの成功基準を適用）
