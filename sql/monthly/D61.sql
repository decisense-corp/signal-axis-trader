-- ============================================================================
-- D61_two_axis_candidate_patterns_buy
-- 2軸パターン候補抽出（BUY版）
-- 
-- 期間設定（ここを変更すれば全体に反映）
-- ============================================================================
...
-- 既存テーブル削除
DROP TABLE IF EXISTS `kabu-376213.kabu2411.D61_two_axis_candidate_patterns_buy`;

-- 新規作成
CREATE TABLE `kabu-376213.kabu2411.D61_two_axis_candidate_patterns_buy` AS
WITH 
-- 1. 2軸パターンの全組み合わせ生成
base_patterns AS (
  SELECT 
