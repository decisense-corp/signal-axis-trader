-- ============================================================================
-- D74_two_axis_patterns_optimized_sell
-- スコア系2軸パターンの損切・利確幅最適化（SELL版）
-- 
-- 期間設定（ここを変更すれば全体に反映）
-- ============================================================================
...
-- 既存テーブル削除
DROP TABLE IF EXISTS `kabu-376213.kabu2411.D74_two_axis_patterns_optimized_sell`;

-- 新規作成
CREATE TABLE `kabu-376213.kabu2411.D74_two_axis_patterns_optimized_sell` AS
WITH 
-- 1. 候補パターンの取得
